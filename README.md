...
<div align="center">
  ...
  <img src="screenshots/local-app.png" alt="Local Application" width="600"/>
  
  <p><strong>User Creation in Postman</strong></p>
  <img src="screenshots/postman-user-creation.png" alt="Postman User Creation" width="600"/>
  
  <p><strong>Application Login</strong></p>
  <img src="screenshots/app-login.png" alt="Application Login" width="600"/>
  
  <p><strong>Docker Container Running</strong></p>
  <img src="screenshots/docker-container.png" alt="Docker Container" width="600"/>
  
  <p><strong>Kubernetes Deployment</strong></p>
  <img src="screenshots/kubernetes-deployment.png" alt="Kubernetes Deployment" width="600"/>
  
  <p><strong>Jenkins Pipeline</strong></p>
  <img src="screenshots/jenkins-pipeline.png" alt="Jenkins Pipeline" width="600"/>
  
  <p><strong>EKS Deployment</strong></p>
  <img src="screenshots/eks-deployment.png" alt="EKS Deployment" width="600"/>
</div>
